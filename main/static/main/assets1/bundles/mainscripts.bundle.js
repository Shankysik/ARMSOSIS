...
$.AdminOreo = {}, $.AdminOreo.options = {
    ...
    activate: function () {
        ...
        var t = $("body"), a = $(".navbar .navbar-header .bars"), i = t.width();
    ...
    activate: function () {
        var a = this, i = $("#rightsidebar"), r = $(".overlay");
        $(window).on("click", function (e) {
            var t = $(e.target);
...
function skinChanger() {
    $(".right-sidebar .choose-skin li").on("click", function () {
        var e = $("body"), t = $(this), a = $(".right-sidebar .choose-skin li.active").data("theme");
...
$.AdminOreo.browser = {
    ...
    $.AdminOreo.browser.activate(), $.AdminOreo.leftSideBar.activate(), $.AdminOreo.rightSideBar.activate(), $.AdminOreo.navbar.activate(),  setTimeout(function () {
